...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    static func pause2xPng(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.pause2xPng
      return fileResource.bundle.url(forResource: fileResource)
    }

    /// `bundle.url(forResource: "play@2x", withExtension: "png")`
    static func play2xPng(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.play2xPng
      return fileResource.bundle.url(forResource: fileResource)
    }
